...
// returns json array [nodes, links]
	...
	var pathindices=[0,0,0,0,0,2,2,2,3,3,3,0,2,1,0,2,3,1,4,1,0,0,2,2]  // 5 means no link
	...
	var destindices=[0,0,0,0,0,5,5,5,3,1,2,0,7,4,7,5,6,4,9,4,7,0,7,8] //10 means direct link
